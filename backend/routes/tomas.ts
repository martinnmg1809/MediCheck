...
// 3. CONSULTAR EL CALENDARIO COMPLETO DEL USUARIO (GET /api/tomas/usuario/:user_id/historial)
// Formatea las fechas y las horas de acuerdo a la zona horaria continental de Santiago de Chile
